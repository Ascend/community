## Ascend Community Command Help

All of the projects in Ascend Community are maintained by Bot.
    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                the label `ascend-cla/yes` will be added in the Pull Request,
                If not, the label `ascend-cla/no` will be added.
            </td>
            <td>
                Anyone
            </td>
