Ascend社区行为准则 1.0 版本
---------------------------------------------
* Ascend社区行为准则是对[CNCF社区行为准则](https://github.com/cncf/foundation/blob/master/code-of-conduct-languages/zh.md)的直接继承。原文本基础上有少许应对Ascend社区具体情况的改动。
...
如需举报侮辱、骚扰或其他不可接受的行为，您可发送邮件至 <ascend@huawei.com>。
